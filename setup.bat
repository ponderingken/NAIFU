...
set ANYTHINGV3_CKPT_URI=https://huggingface.co/Linaqruf/anything-v3.0/resolve/main/Anything-V3.0.ckpt
set ANYTHINGV3_PT_URI=https://huggingface.co/Linaqruf/anything-v3.0/resolve/main/Anything-V3.0.vae.pt
...
echo Downloading the Anything-V3
"%~dp0tmp\aria2c.exe" --dir="%~dp0tmp" --out="model.ckpt"  %ANYTHINGV3_CKPT_URI%
"%~dp0tmp\aria2c.exe" --dir="%~dp0tmp" --out="Anything-V3.0.vae.pt"  %ANYTHINGV3_PT_URI%
...
rd /s /q "%~dp0tmp\naifu"
mkdir "%~dp0models\Anything-V3.0"
move "%~dp0tmp\model.ckpt" "%~dp0models\Anything-V3.0\" > nul
move "%~dp0tmp\Anything-V3.0.vae.pt" "%~dp0models\" > nul
copy "%~dp0models\animefull-final-pruned\config.yaml" "%~dp0models\Anything-V3.0\config.yaml" > nul
